...
#################### Collect and plot data #####################################
  ...
  title<- list(text = "Omega_arag contours for DIC and TA", x = .55)
  ...
  plot <- plot %>% add_trace(x = DIC, y = Alk,
                ...
                contours = list(start = -1, end = 25, size = .2,
